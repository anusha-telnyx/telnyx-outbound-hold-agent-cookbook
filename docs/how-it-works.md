...
This fake hotel is not a Telnyx AI Assistant. It is a TeXML test fixture generated by the local FastAPI app so users can test IVR navigation, hold detection, assistant stop, representative pickup detection, and Assistant 2 startup without needing a second company-owned AI agent. It is intentionally not a full conversational booking agent. In the Telnyx portal, you should see the two outbound assistants only: IVR navigation and representative interaction.
